  ...
  return (
    ...
    <Swiper
      ...
      >
        ...
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/rgcsm.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/hrp.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/bachpan.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/global.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/healthpart.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[200px] h-[200px] flex justify-center items-center p-4">
            <img src="/parents.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        {/* <SwiperSlide className="text-center text-xl flex justify-center items-center">
      ...
      >
        ...
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[500px] h-[250px] flex justify-center items-center p-4">
            <img src="/rgcsm.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
        ...
        <SwiperSlide className="text-center text-xl flex justify-center items-center">
          <div className="w-[500px] h-[200px] flex justify-center items-center p-4">
            <img src="/parents.png" className={`${styles.responsive}`}/>
          </div>
        </SwiperSlide>
        {/* <SwiperSlide className="text-center text-xl flex justify-center items-center">
